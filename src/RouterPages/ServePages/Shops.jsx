...
<h3 className='font-semibold text-white text-[20px] text-opacity-90'>
...
<button className='border-2 bg-[#01c7b1] border-[#01c7b1]  text-white font-bold text-[13px] p-2 rounded-md'>START NOW</button>
            ...
            <div className='flex flex-row items-center justify-between p-4'>
                <span className='flex flex-col gap-2'>
                    ...
                    <button className='border-2 bg-[#01c7b1] w-[20%] border-[#01c7b1]  text-white font-bold text-[13px] p-2 rounded-md'>
                        ADD MY SHOP
                    </button>
                </span>
<img src={increaseSales}/>
            ...
            <div className='py-10 bg-[#F0FFFA] flex flex-row items-center justify-center gap-10'>
...
Gain insights on customer needs and purchase patterns.
            ...
            <div className='flex flex-row justify-between py-20 px-4'>
...
<span className='flex flex-col gap-2'>
                ...
                <img src={ordersAround} className='w-[35%]'/>
            </div>

            <div className=' flex flex-row items-center gap-20 bg-[#F0FFFA] py-14 justify-center'>
<img src={promotype}/>
...
function ShopCard(props){
    return (
        <div className='flex flex-col p-2 gap-2 w-[30%]  items-center'>
